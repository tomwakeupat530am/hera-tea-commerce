  ...
  return (
    <Layout>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="section-heading text-center mx-auto">Khách hàng nói gì về chúng tôi</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            <div className="bg-tea-light p-6 rounded-lg">
              <div className="flex items-center text-tea-gold mb-4">
              ...
              <p className="italic mb-4">"Thanh sắc mộc trà của Hera Tea là một trong những loại trà ngon nhất mà tôi từng thưởng thức. Hương vị tinh tế, thơm ngon và rất dễ uống."</p>
            ...
            <div className="bg-tea-light p-6 rounded-lg">
              ...
              <p className="italic mb-4">"An nguyệt mộc trà thực sự giúp tôi có được những giấc ngủ ngon và sâu hơn. Đây là thức uống tuyệt vời vào buổi tối."</p>
            ...
            <div className="bg-tea-light p-6 rounded-lg">
              ...
              <p className="italic mb-4">"Tôi đã giới thiệu Thái mộc mộc trà cho bạn bè và họ đều rất hài lòng với chất lượng. Sản phẩm xứng đáng với giá tiền."</p>
